...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 480, "Vulkan", nullptr, nullptr);
    Vulkan vulkan;
    vulkan.Init(window);
...
int Vulkan::Init(GLFWwindow* window)
{
...
#endif
    VkInstanceCreateInfo instInfo{ VK_STRUCTURE_TYPE_INSTANCE_CREATE_INFO,0,0,0,layers.size(),layers.data(),extensionCount,extensions };
